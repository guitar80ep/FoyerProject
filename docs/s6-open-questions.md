...
| 16 | Polyglass Supplier | Confirm Polyglass ADESO product availability (Elastoflex SA V Plus, Elastoflex SA V, Polyfresko G SBS SA) and lead time with local supplier. | Cannot order membrane materials without confirmed availability. Use same supplier as main roof if possible. | [PRE-ORDER] |
| 7 | Rain Chain Drop Height | Exact vertical drop from scupper spout to rock garden bed surface? | Measured drop is ~12 ft; order 13 ft chain. Field-verify before ordering. | [PRE-ORDER] |
...
| 17 | Scupper + Overflow Configuration | Will Redondo Beach B&S accept the Thunderbird SPDSRCB3NH integrated primary + overflow drain (single unit, single parapet penetration, shared 3″ no-hub spout) as satisfying CBC §1502.2 overflow requirement? Or does the inspector require a separate free-discharge overflow scupper visible on the exterior parapet face? Contact Redondo Beach B&S: (310) 318-0637. | GATES parapet framing rough opening count (1 vs. 2) and drain order. If separate overflow required: add Thunderbird SS Separate Parapet Overflow Drain (316 SS, made-to-order), frame 2 rough openings 6–8″ apart, second unit free-discharges to exterior parapet face. Do not frame parapet or order SPDSRCB3NH until resolved. | [PRE-ORDER] |
...
| 11 | Tile Selection | Which specific porcelain tile (style, color, format) for walls and coping? | Evaluate 3–4 samples in outdoor Blossom Lane light alongside Thermo Radiata samples. Confirm with Planning Dept. | [PRE-ORDER] |
| 12 | Title 24 Compliance | Does Redondo Beach B&S require roof insulation for Title 24 CZ6? Unconditioned semi-outdoor may be exempt. Polyfresko G SBS SA cap sheet meets cool-roof SRI standards (initial: 96, aged: 82) if cool-roof credit is relevant. | If required: add 1.5″–2″ polyiso under membrane, adjust parapet height accordingly. | [PRE-ORDER] |
