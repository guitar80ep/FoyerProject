...
_All CBC sections, ANSI/ASTM standards, Title 24 requirements, manufacturer specs, and municipal code references cited anywhere in the project. Other section files cite standards by name and point here with `→ see §10`._

_Sort: alphabetical by Code / Standard name._
...
| ASTM D6164 | Standard specification for SBS-modified bitumen sheet materials using polyester reinforcements — cap sheet membranes (Polyglass Polyfresko G SBS SA) | §3.C, §5 |
...
| CBC 2022 §1503.4 | Primary roof drainage — requirements for drainage of roof areas | §3.C |
| CBC 2022 §1503.4.2 | Overflow (secondary) drainage — required for roof areas enclosed by parapets where ponding could occur if primary drain is blocked | §3.C, §5, §8 |
